    ...
    <div class="row">
        <div class="col-md-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <form action="{{ route('produksi.update', $produksi->KodeProduksi) }}" method="post" class="formsub">
                        @csrf
                        @method('put')
                        <!-- Contents -->
                        <br>
                        <div class="form-row col-md-12">
                            ...
                            <div class="form-group col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control bahanjadi" id="kodeproduksi" value="{{$produksi->KodeProduksi}}" readonly>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="hidden" nomor="{{$loop->iteration}}" name="NamaResepProduksi" value="{{$produksi->NamaItem}}">
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                                ...
                                <table id="items" class="table">
                                    ...
                                    @endif
                                        ...
                                        <td>
                                            ...
                                            <input type="hidden" name="OldKaryawanProduksi[]" value="{{$detail->KodeKaryawan}}">
                                        </td>
                                        <td>
