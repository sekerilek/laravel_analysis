                    ...
                    <form action="{{ url('/kasir/store') }}" method="post" class="formsub">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                    ...
                                    <input type="number" required step=0.01 onchange="disc()" class="diskon form-control" name="diskon" placeholder="Rp" readonly value="0">
                                    <a class="btn-xs btn btn-success" data-toggle="modal" data-target="#modelId">
                                        <i class="fa" aria-hidden="true"></i> Input
                                    </a>
                                </div>
                            <div class="form-group">
                                ...
                                <div>
                                    ...
                                    <input class="form-control" name="Keterangan" value="-" readonly id="inputKeterangan" rows="5"></input>
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                                ...
                                <table id="items" class="table">
                                    <tr>
										...
										<select class="form-control" name="hrg" id="hrg">
                                                ...
                                                <option value="Hargagrab">Harga Grab</option>
                                                <option value="Hargashopee">Harga Shopee</option>
                                            </select>
											</td>
                                    ...
                                    <tr class="rowinput">
                                        ...
                                        <td>
                                            <input type="number" step="1" oninput="qty(1)" name="qty[]" class="form-control qty1" min="0" value="0" required="">
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <input type="number" oninput="price(1)" name="price[]" class="form-control price1" required value="0" readonly>
                                        </td>
                                        <td>
                                ...
                                <div class="modal-dialog">
                                    ...
                                    <div class="modal-body">
                                        <form id="formD" name="formD" action="" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                            <label for="inputPelanggan">Total</label>
                                            <input type="hidden" readonly="" class="form-control subtotal" id="subtotal2" value="0" name="subtotal" placeholder="" onKeyPress="return isNumberKey(event)">
...
$(document).ready(function() {
    $("#subtotal, #bayar").keyup(function() {
        var harga  = $("#subtotal").val();
