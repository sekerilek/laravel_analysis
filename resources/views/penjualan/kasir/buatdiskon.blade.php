                    ...
                    <form action="{{ url('/kasir/store') }}" method="post" class="formsub">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                    ...
                                    <input type="number" required step=0.01 onchange="disc()" class="diskon form-control" name="diskon" placeholder="Rp" value="0">
                                </div>
                            <div class="form-group">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <table id="items" class="table">
                                    ...
                                    <tr class="rowinput">
                                        ...
                                        <td>
                                            <input type="text" onchange="price(1)" name="price[]" class="form-control price1" required="" value="0" readonly>
                                        </td>
                                        <td>
