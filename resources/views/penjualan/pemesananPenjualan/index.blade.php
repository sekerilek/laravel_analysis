            ...
            <div class="x_panel">
                <div class="x_title">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <br><br>
                            <a href="{{ url('/sopenjualan/create')}}" class="btn btn-primary pull-right" data-function="tambah">
                ...
                <div class="x_content">
                    <table class="table table-light" id="table">
                        ...
                        <tr>
                            ...
                            <td>{{ date_format(date_create($p->tgl_kirim), 'd F Y') }}</td>
                            <td>{{ $p->NamaPelanggan }}</td>
                            <td>Rp. {{ number_format($p->Total, 0, ',', '.') }}</td>
                            <td>
                                @if($p->Status == 'OPN')
                                <a href="{{ url('/sopenjualan/confirm/'.$p->KodeSO)}}" class="btn-xs btn btn-info" onclick="return confirm('Konfirmasi data ini?')" data-function="konfirmasi">
                                    <i class="fa fa-check" aria-hidden="true"></i>
                                </a>
                                <a href="{{ url('/sopenjualan/show/'. $p->KodeSO )}}" class="btn-xs btn btn-primary">
                                    <i class="fa fa-eye" aria-hidden="true"></i> Lihat
                                </a>
                                <a href="{{ url('/sopenjualan/edit/'. $p->KodeSO )}}" class="btn-xs btn btn-success" data-function="ubah">
                                    <i class="fa fa-pencil" aria-hidden="true"></i> Ubah
                                </a>
                                <a href="{{ url('/sopenjualan/destroy/'.$p->KodeSO)}}" class="btn-xs btn btn-danger" onclick="return confirm('Apakah anda yakin ingin menghapus data ini?')" data-function="hapus">
