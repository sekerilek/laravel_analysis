                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" required step=0.01 onchange="disc()" class="diskon form-control" name="diskon" id="inputBerlaku" placeholder="%">
                                </div>
                            </div>
                            <!-- pembatas -->
                            <div class="form-group col-md-1"></div>
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control b" name="NoFaktur" id="inputFaktur">
                                </div>
                                <div class="form-group">
                                    <label class="ekspedisi">Ekspedisi</label>
                                    <select class="form-control ekspedisi" onchange="eksfunc(this)" name="ekspedisi" id="ekspedisi">
                                        ...
                                        <option data-price="{{ $eks->TarifPelanggan }}" value="{{$eks->KodeEkspedisi}}">{{$eks->NamaEkspedisi}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <table id="items" class="table">
                                    <tr>
                                        ...
                                        {{-- <td id="header" style="width:18%;">
                                        <a href="" class="btn btn-primary form-control" data-toggle="modal" data-target="#ModalCreate">
                                            <span style="color:white"></span>{{ __('Harga') }}
                                        </a>
                                        </td> --}}
                                        <td id="header">
                                            {{-- <label for="harga">
                                                <input type="radio" name="harga" id="harga" value="Harga">Harga Satuan
                                                <input type="radio" name="harga" id="harga" value="Hargagros">Harga Grosir
                                            </label> --}}
                                            <select class="form-control" name="hrg" id="hrg">
                                                <option value="">--Pilih Harga--</option>
                                                <option value="Harga">Harga Pokok</option>
                                                <option value="Hargagros">Harga Ecer</option>
                                            </select>
                                        </td>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <label for="inputPelanggan">Ekspedisi</label>
                                    <input type="hidden" readonly value="0" name="eksval" class="eksval form-control">
                                    <input type="text" readonly="" class="form-control showeksval" value="Rp 0,-">
...
<script type="text/javascript">
    ...
    function updatePrice(tot) {
        ...
        if ($("#ekspedisi").val() != "") {
        var tar = $('#ekspedisi option:selected').data('price');
        }else{
            var tar = 0;
        }
        // $(".eksval").val(tar);
