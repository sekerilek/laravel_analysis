        ...
        <div class="col-md-12">
            <div class="x_panel">
                <div class="x_title">
                    ...
                    <h3 id="header" class="b">N{{$newIDP}}</h3>
                </div>
                <div class="x_content">
                    <form action="{{ url('/pembelian-langsung/store') }}" method="post" class="formsub">
                        @csrf
                        <!-- Contents -->
                        <br>
                        <div class="form-row">
                                    ...
                                    <tr class="rowinput">
                                        <td>
                                            <select name="item[]" onchange="barang(this,1);" class="form-control item1" id="item-select1">
                                                ...
                                                {{$data->SisaStok <= 0 ? 'enabled' : ''}}
                                            >{{$data->NamaItem}}</option>
                                                @endforeach
                                            </select>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <input readonly type="text" class="form-control keterangan1" name="keterangan[]" required="" value="0">
                                        </td>
                                        <td>
...
<script type="text/javascript">
    ...
    let trsatuan = $('option:selected', $tr).data('satuan');
    let trketerangan = $('option:selected', $tr).data('keterangan');
