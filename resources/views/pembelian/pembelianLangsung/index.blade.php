...
<div class="container">
  <div class="row">
    <div class="col-md-12">
      <div class="x_panel">
        <div class="x_title">
          <form action="{{ url('/pembelian-langsung')}}">
            ...
            <button class="btn btn-default"><a href="{{ url('/popembelian/export')}}">Excel</a></button>
          </form>
        </div>
        <div id="filter" class="collapse">
          <form action="{{ url('/pembelian-langsung/cari')}}" method="get">
            <div class="x_content">
        ...
        <div class="x_title">
          <div class="row">
            <div class="col-md-6 col-sm-6">
              <h3>Pembelian Langsung - Non PO</h3>
              <p>Purchase Order<p>
            </div>
            <div class="col-md-6 col-sm-6">
              <br><br>
              <a href="{{ url('/pembelian-langsung/create')}}" class="btn btn-primary pull-right" data-function="tambah">
        ...
        <div class="x_content">
          <table class="table table-light" id="table">
            ...
            <tr>
              ...
              <td>
                @if($p->Status == 'OPN')
                <a href="{{ url('/pembelian-langsung/confirm/'.$p->KodePO)}}" class="btn-xs btn btn-info" onclick="return confirm('Konfirmasi data ini?')" data-function="konfirmasi">
                  <i class="fa fa-check" aria-hidden="true"></i>
                </a>
                <a href="{{ url('/pembelian-langsung/show/'. $p->KodePO )}}" class="btn-xs btn btn-primary">
                  <i class="fa fa-eye" aria-hidden="true"></i> Lihat
                </a>
                <a href="{{ url('/pembelian-langsung/edit/'. $p->KodePO )}}" class="btn-xs btn btn-success" data-function="ubah">
                ...
                <a href="{{ url('/returnPenerimaanBarang/create/'. $p->KodePenerimaanBarang )}}" class="btn-xs btn btn-warning" data-function="return">
                  <i class="fa fa-undo" aria-hidden="true"></i> <b>Return</b>
              </a>
                @endif
                <a href="{{ url('/pembelian-langsung/destroy/'.$p->KodePO)}}" class="btn-xs btn btn-danger" onclick="return confirm('Apakah anda yakin ingin menghapus data ini?')" data-function="hapus">
