        ...
        <div class="col-md-12">
            <div class="x_panel">
                <div class="x_title">
                    ...
                    <a href="{{ url('/pelunasanhutang/invoice/'.$supplier->KodeSupplier.'')}}" class="btn btn-success pull-right">
                        <b>Pilih Invoice</b>
                    </a>
                    <br><br>
                </div>
                    ...
                    <table class="table table-light" id="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url('/pelunasanhutang/payment/'.$payment->KodePelunasanHutangID.'/edit')}}" class="btn-xs btn btn-success">
