...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <div class="x_panel">
                <div class="x_title">
                    <h1 id="header">Stok Masuk</h1><br>
                    <form action="{{ url('/stokmasuk') }}" method="get" style="display:inline-block;">
                    ...
                    <a href="{{ url('/stokmasuk/create')}}" class="btn btn-primary pull-right" data-function="tambah">
                        <i class="fa fa-plus" aria-hidden="true"></i>
                    </a>
                    <br>
                    <div id="filteritem" class="collapse">
                        <div class="row">
                            <form action="{{ url('/stokmasuk/filter') }}" method="post">
                                @csrf
                                <div class="x_content">
                    ...
                    <div id="filtertanggal" class="collapse">
                        <form action="{{ url('/stokmasuk/filterdate')}}" method="post">
                            @csrf
                            <div class="x_content">
                                <div class="col-md-2 col-sm-2">
                                    <div class="form-group">
