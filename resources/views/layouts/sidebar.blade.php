        ...
        <ul class="nav side-menu">
            <li>
                ...
                <ul class="nav child_menu">
                    <li><a href="{{ url('/masterklasifikasi') }}">Klasifikasi</a></li>
                    <li><a href="{{ url('/mastersatuan') }}">Satuan</a></li>
                    <li><a href="{{ url('/masteritem') }}">Item</a></li>
                    <li><a href="{{ url('/masterpaket') }}">Paket</a></li>
                    <li><a href="{{ url('/masterpelanggan') }}">Pelanggan</a></li>
                </ul>
            </li>
