                    ...
                    <form action="{{ route('rekammedis.update') }}" method="post">
                        ...
                        <div class="col-md-6">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <form action="{{ route('rekammedis.update') }}" method="post" style="display:inline-block;">
                                        @csrf
                                        @method('POST')
                                        <div class="form-group">
                                            <label>Kode Rekam Medis: </label>
                                            @foreach($rekammedis as $rm)
                                            <input type="text" readonly name="KodeRekamMedis" value="{{$rm->KodeRekamMedis}}" class="form-control">
                                            @endforeach
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group date" id="inputDate">
                                                @foreach($rekammedis as $rm)
                                                <input type="text" class="form-control" name="Tanggal" id="inputDate" value="{{$rm->Tanggal}}">
                                                @endforeach
                                        ...
                                        <div class="form-group">
                                            ...
                                            @foreach($rekammedis as $rm)
                                            <textarea style="resize: none; height:180px;" type="text" required="required" name="CatatanMedis" placeholder="Catatan Medis" class="form-control" maxlength="191">{{$rm->CatatanMedis}}</textarea>
                                            @endforeach
                                        </div>
                                </div>
                            </div>
