        ...
        <div class="col-md-12">
            <div class="x_panel">
                <div class="x_title">
                    ...
                    <h1 id="header">Invoice Piutang</h1><br>
                    <form action="{{ url('/invoicepiutang') }}" method="get" style="display:inline-block;">
                    ...
                    <div id="filteritem" class="collapse">
                        <div class="row">
                            <form action="{{ url('/invoicepiutang/filter') }}" method="post">
                                @csrf
                                <div class="x_content">
                        ...
                        <tbody>
                            ...
                            @if ($inv->Subtotal <= $inv->bayar + $inv->TotalReturn)
                                <tr class="success">
                                    ...
                                    <td>
                                        <a href="{{url('invoicepiutang/print/'.$inv->KodeInvoicePiutangShow)}}" class="btn btn-xs btn-primary" onclick="return confirm('Print invoice ini?')" data-function="cetak">Print</a>
                                        @if($inv->PPN == "ya")
                                        <a href="{{url('invoicepiutang/edit/'.$inv->KodeInvoicePiutangShow)}}" class="btn btn-xs btn-success" data-function="ubah">
