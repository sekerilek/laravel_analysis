        ...
        <div class="col-md-12">
            <div class="card uper">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <form action="{{ url('/laci/store') }}" method="post" style="display:inline-block;">
                            @csrf
                            @method('POST')
                            <div class="form-group col-md-4">
                                <div class="form-group">
                                    <label>Nama Biaya:</label>
                                    <input type="text" required="required" name="Nama" class="form-control" value="kas laci" disabled>
