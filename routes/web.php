...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::resource('/masterpaket', 'MasterPaketController');
    ...
    Route::get('/masterpaket/delete/{id}', 'MasterPaketController@destroy');
    ...
    Route::get('laci/store','KasLaciController@store');
    ...
    Route::get('/resep', 'ProduksiController@resep');
    Route::get('/resep/{param}', 'ProduksiController@resepData');
    Route::post('/resep/upload', 'ProduksiController@resepUpload');
